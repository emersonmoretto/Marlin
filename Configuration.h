...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -18.88
  ...
  #define Z_RAISE_BEFORE_PROBING 22    //How much the extruder will be raised before traveling to the first probing point.
...
#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 80,0} // X,Y,Z Axis Extend and Retract angles
